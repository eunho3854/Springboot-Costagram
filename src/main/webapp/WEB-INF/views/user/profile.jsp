  ...
  <div class="profileContainer">
    ...
    <div class="profile-left">
      <div class="profile-img-wrap story-border" onclick="popup('.modal-image')">
        <img src="/upload/${dto.user.profileImageUrl}" alt="" onerror="this.src='/images/punch.png'"/>
    ...
    <!--유저정보 및 사진등록 구독하기-->
    <div class="profile-right" id="profile_follow_btn">
          ...
          <c:otherwise>
            <c:choose>
              <c:when test="${dto.followState}">
                <button class="cta blue" onclick = "followOrunfollowProfile(${dto.user.id})">구독취소</button>
              </c:when>
              <c:otherwise>
                <button class="cta" onclick = "followOrunfollowProfile(${dto.user.id})">구독하기</button>
              </c:otherwise>
            </c:choose>
